...
<body>
	<div id="container">
		<div id="header">
			<ul>
				<li><?php echo $this->Html->link('Scheduled Tasks','/manage/commands') ?></li>
				<li><?php echo $this->Html->link('Licenses', '/manage/licenses') ?></li>
				<li><?php echo $this->Html->link('Programs','/manage/restricted_programs') ?></li>
