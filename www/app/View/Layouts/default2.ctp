          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 ml-1 d-none d-lg-inline text-gray-600 small"><?php echo $this->Session->read('username') ?></span>
                <?php echo $this->Html->image('/img/user-profile-smile.svg',array('class'=>'img-profile rounded-circle')) ?>
              </a>
