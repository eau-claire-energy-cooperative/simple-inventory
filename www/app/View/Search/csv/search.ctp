...
//header values
$headers = array('Computer Name','Current User','Location','Serial Number','Asset ID','Model','Operating System','CPU','Memory','Number of Monitors','IP Address','MAC Address','C: Drive Space','Last Updated');
