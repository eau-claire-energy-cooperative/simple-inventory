  ...
  <div class="row mt-3">
    <div class="col-md-8">
      <?php if($isDue): ?>
        ...
        <div class="row">
          <div class="col-md-3"><p class="mt-2"><b>New Version: </b></p></div>
          <div class="col-md-5">
            <?php echo $this->Form->input('version', array("label"=>false, 'div'=>false, 'class'=>'form-control', 'value'=>$application['Applications']['version'])); ?>
          </div>
          <div class="col-md-4"><button class="btn btn-success">Mark Upgraded</button></div>
        </div>
        <div class="row">
          <div class="col-md-12"><i>Updating the version to the most current will update this application entry. If an existing application with this version already exists, the update will fail.</i></div>
        </div>
        </div>
      <?php endif; ?>
      <h3>Notes: </h3>
