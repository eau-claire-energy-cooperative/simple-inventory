...
<?php
  ...
  $assignedAttributes = explode(',', $device['attributes']);
?>
<div class="row">
  <div class="col-xl-12">
    <div class="card shadow mb-4">
        <div class="card-body">
          ...
          <div class="row mb-2">
            ...
            <div class="col-md-7"><?= $this->Form->input('icon', ['class'=>'form-control', 'onkeyup'=>'updateIcon()', 'id'=>'DeviceTypeIcon']); ?></div>
            <div class="col-md-1"><i class="mdi mdi-<?= $device['icon'] ?>" style="font-size:24px" id="device_icon_preview"></i></div>
          </div>
          <div class="row mb-2">
            <div class="col-sm-4">Attributes Allowed:</div>
            <div class="col-sm-8"><?= $this->Form->select('attributes', $allowedAttributes, ['class'=>'custom-select','multiple'=>true,'value'=>$assignedAttributes]) ?><br />
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-8"><?= $this->Form->select('allow_decom', ['false'=>'No', 'true'=>'Yes'], ['class'=>'custom-select','empty'=>false]) ?><br />
            This controls if decomissioning is allowed for this device type.
            </div>
          </div>
          <div class="row mb-2">
            <div class="col-sm-4">Check Running Status:</div>
            <div class="col-sm-8"><?= $this->Form->select('check_running', ['false'=>'No', 'true'=>'Yes'], ['class'=>'custom-select','empty'=>false]) ?><br />
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-8"><?= $this->Form->select('exclude_ad_sync', ['false'=>'No', 'true'=>'Yes'], ['class'=>'custom-select','empty'=>false]) ?><br />
